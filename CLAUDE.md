...
- 2026-09-25 第6案「江戸和モダン」①〜④（ご本人合意。⑤浮世絵風イラストは保留）：
  - ①文様の家紋：ツアーごとに文様を1つ持つ（`pattern`：seigaiha／asanoha／yagasuri／kikko／uroko／shippo／ichimatsu／tatewaku、`src/lib/patterns.ts`）。カード左上の丸い紋、カード裏面の帯、ツアーページのヒーロー下の帯、トップのヒーロー下に全ツアーの文様を並べた帯（`PatternBand.astro`）。
  ...
  - ④絵巻：紙の上下を破れた和紙の縁に、闇に差す斜めの光と周囲を暗くする陰影を追加。表紙の題箋は縦書き「新宿の一夜」。
