...
- 忍術診断（第13回）：背景を明るい和紙色に変更（下の紺の絵巻と区別）。選択肢は白いカード＋紺の枠と影＋紺の丸にアイコン、ホバーで紺に反転、選んだものに✓。3問目を選ぶと、答えは見せずに「ぼっ！」と忍者の煙が広がり、紺の絹に金の紐を結んだ巻物（YOUR MISSION／Tap to open）が現れる。タップすると軸が左右に開いて結果（写真・ツアー名・料金・予約・See its route）が出る。開いた時点で下の絵巻もそのツアーに差し替わる。GA4イベント `quiz_open`。
