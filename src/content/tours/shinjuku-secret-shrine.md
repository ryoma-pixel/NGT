...
highlights:
  - { icon: "🥷", title: "Adventure with a Ninja", text: "Safely explore Kabukicho, the “City That Never Sleeps,” guided by a modern-day Ninja." }
  - { icon: "🏮", title: "The contrast of calm and chaos", text: "Visit silent shrines and retro alleys hidden right behind the world-famous neon streets." }
  - { icon: "⛩️", title: "A secret “power spot”", text: "Find a hidden shrine not listed in standard guidebooks, and hear the legend of a stone said to bring good luck 🍀." }
  - { icon: "📸", title: "Perfect photo ops", text: "Your guide helps you take the best photos under the Kabukicho Ichibangai Arch and the famous Godzilla Head 🦖." }
  - { icon: "👨‍👩‍👧", title: "Kids go free", text: "Children 12 and under join free with a paying adult. Families are welcome." }
itinerary:
  - { title: "Meeting & introduction (5 min)" }
  - { title: "Kabukicho Ichibangai & Sakura-dori (10 min)" }
  - { title: "Infiltrate the secret shrine (15 min)" }
  - { title: "Golden Gai & Hanazono Shrine (25 min)" }
  - { title: "Dismissal (5 min)" }
itineraryNote: "The tour ends in a restaurant area, so you can head straight to dinner in Shinjuku."
notes:
  - { title: "Costs", text: "Food and drinks are not included. This is a walking tour and does not include entering bars for drinks or meals during the tour." }
  - { title: "What to wear", text: "We walk for about 60 minutes, so please wear comfortable walking shoes." }
  - { title: "Weather", text: "The tour runs in light rain and is cancelled only in stormy weather." }
  - { title: "Families", text: "Children 12 and under are free. Children must be accompanied by a guardian." }
